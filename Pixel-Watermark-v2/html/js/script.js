...
// Til et andet script også men skal ikke slettes (Andet Script Er I ESX By Pixel)
...
// Skift Det Lort Ud Hvis Du ville
$(function() {
    moment.locale('da-DK');
    function iniciarHorario() {
      document.getElementById('horario').innerHTML = "<h3>" + moment().format(`DD/MM/YYYY - HH:mm:ss`) +  "</h3>";
      document.getElementById('players').innerHTML = "<h3>" +"Online: " + playerCount +  "/200 - ID: " + playerId + "</h3>";
...
// Logo Skal Ikke Bruges Lige Nu Men Ik Slet;)
var slideIndex = 0;
showSlides();
